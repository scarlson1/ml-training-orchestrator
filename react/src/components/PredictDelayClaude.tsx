...
import type { PredictBody, PredictResponse } from './PredictDelay';
...
const Cell = ({
  ...
  <Box sx={{ flex: 1, px: 2.5, pt: 1.5, pb: 2, minWidth: 0 }}>
    <Typography
      sx={{
        fontSize: 11,
...
interface PredictDelayClaudeProps {
  onPredict: (data: PredictResponse) => void;
}

export const PredictDelayClaude = ({ onPredict }: PredictDelayClaudeProps) => {
