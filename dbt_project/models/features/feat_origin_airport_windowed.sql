select
    ...
    -- 24-hour window
    count(*) over w_24h                             as origin_flight_count_24h,
    avg(dep_delay_min) over w_24h                   as origin_avg_dep_delay_24h,
...
window
    ...
    w_7d as (partition by origin order by scheduled_departure_utc
